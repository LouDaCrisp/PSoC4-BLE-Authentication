    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'A', (uint8)'u', (uint8)'t', (uint8)'h', (uint8)'e', (uint8)'n', (uint8)'t', (uint8)'i', (uint8)'c',
    (uint8)'a', (uint8)'t', (uint8)'i', (uint8)'o', (uint8)'n',
...
const uint8 cyBle_attUuid128[][16u] = {
    /* Custom Service */
    { 0x31u, 0x01u, 0xB3u, 0xF9u, 0x05u, 0x08u, 0x00u, 0x00u, 0x08u, 0x00u, 0x01u, 0x00u, 0x34u, 0x12u, 0x03u, 0x00u },
    /* Custom Characteristic */
    { 0x31u, 0x01u, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0xCDu, 0xABu, 0x03u, 0x00u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[28] }, /* Custom Characteristic */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x0Eu] = {
    ...
    { 0x0003u, 0x2A00u /* Device Name                         */, 0x010A0701u /* rd,wr  */, 0x0003u, {{0x000Eu, (void *)&cyBle_attValuesLen[0]}} },
    ...
    { 0x000Bu, 0x2902u /* Client Characteristic Configuration */, 0x010A0701u /* rd,wr  */, 0x000Bu, {{0x0002u, (void *)&cyBle_attValuesLen[4]}} },
    { 0x000Cu, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x000Eu, {{0x0010u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00060001u /* rd,wwr */, 0x000Eu, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Eu, 0xABCDu /* Custom Characteristic               */, 0x09060707u /* rd,wwr */, 0x000Eu, {{0x0001u, (void *)&cyBle_attValuesLen[7]}} },
};
